...
dragElement(document.getElementById("external-events-list"));
...
function dragElement(elmnt) {
    var pos1 = 0,
        ...
        pos3 = 0,
        pos4 = 0;
    if (document.getElementsByClassName("btn-info")) {

        // if present, the header is where you move the DIV from:
        document.document.getElementsByClassName("btn-info").onmousedown = dragMouseDown;
    } else {
